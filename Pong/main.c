...
if (!font) {
  ...
  al_set_new_display_flags(ALLEGRO_WINDOWED);
    ...
    float carta_pos_x = SCREEN_W/2 - BARALHO_LARGURA;

    float carta_pos_y = SCREEN_H  - BARALHO_LARGURA ;
...
int a =1;
    ...
    carta=al_load_bitmap("imagens/AO.png");
    }
    else{
    carta=al_load_bitmap("imagens/5E.png");
    ...
    0                                      // flags
            ...
            al_draw_bitmap(carta, carta_pos_x, carta_pos_y, 0);
